    ...
    <StyledFarmStakingCard className="white_box vision_card_panel">
      <CardBody>
        <Heading size="md" mb="15px"  style={{ fontWeight: 400, fontSize: "24px", fontFamily: "Roboto', sans-serif" }}>
          {TranslateString(542, 'What is the vision of OrangeSwap?')}
        </Heading>
        ...
        <Heading size="md">
          <a className="hvd_comic_serif" style={{ fontSize: "30px" }} href="https://orangeswap.medium.com/">{TranslateString(542, 'Check it Out!')}</a>
        </Heading>     
      </CardBody>
