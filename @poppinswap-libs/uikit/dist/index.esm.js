...
var Icon$c = function (props) {
    var theme = useTheme();
    var primaryColor = theme.isDark ? "#3C3742" : "#e0b87d";
    var secondaryColor = theme.isDark ? "#fff" : "#a7623c";
...
var Icon$M = function (props) {
    return (
        React.createElement("img", {src:'/images/cfo-ico.png', className:"icon_sidebar" })
    );
};
// var Icon$N = function (props) {
//     return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$N = function (props) {
    return (
        React.createElement("img", {src:'/images/gbps-ico.png', className:"icon_sidebar" })
    );
};
var Icon$O = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 125 26" }, props),
        React.createElement("image", { width: "125", height: "26", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Icon$R = function (props) {
    return (
        React.createElement("img", {src:'/images/nft.png', className:"icon_sidebar" })
    );
};
...
var Icon$V = function (props) {
    return (
        React.createElement("img", {src:'/images/lottery-ico.png', className:"icon_sidebar" })
    );
};
// var Icon$W = function (props) {
//     return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://twitter.com/tnoxswap",
        // items: [
        //     {
        //         label: "English",
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://telegram.me/tnoxswap",
    },
];
var MENU_HEIGHT = 64;
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        console.log("entry href",entry.href,window.location.href);
...
var StyledPanel = styled.div(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n    width: ", ";\n  }\n"], ["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n    width: ", ";\n  }\n"])), function (_a) {
    ...
    var theme = _a.theme;
    return theme.colors.navbackground;
}, function (_a) {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { navbackground:"#fff3e0",color_balck:"000",color_blue:"#000",primaryblack:"#000",textblack:"#ccc",orange_color:"#f3841e",orangetext_subhead:"#333",dash_heading:"#333",navbackground: "#fff3e0", background: "#fff3e0", textblack:"#333", backgroundDisabled: "#e0b87d", contrast: "#333", invertedContrast: "#FFFFFF", input: "#e0b87d", inputSecondary: "#e0b87d", tertiary: "#fbe9cc", text: "#000", textDisabled: "#a7623c", textSubtle: "#6e2d0a", borderColor: "#e0b87d", card: "#fff",  card_small: "#333", gradients: {
    bubblegum: "linear-gradient(139.73deg, #fff 0%, #fff 100%)",
} });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { navbackground:"#1a110d",color_balck:"fff",color_blue:"#fff",primaryblack:"#fff",textblack:"#fff",orange_color:"#f3841e", orangetext_subhead:"#fff",dash_heading:"#fff",secondary: "#fff", textblack:"#fff", navbackground: "#1a110d", background: "#1a110d", backgroundDisabled: "#6e2d0a57", contrast: "#FFFFFF", invertedContrast: "#6e2d0a7d", input: "#6e2d0a7d", inputSecondary: "#6e2d0a7d", primaryDark: "#0098A1", tertiary: "#1a110d", text: "#fff", textDisabled: "#fff",  card_small: "#fff",textSubtle: "#fff", borderColor: "#33190b", card: "#170903", new: "#ffffff", gradients: {
